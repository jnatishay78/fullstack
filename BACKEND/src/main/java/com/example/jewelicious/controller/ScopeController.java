...
import com.example.jewelicious.scope.ApplicationScopedBean;
import com.example.jewelicious.scope.RequestScopedBean;
import com.example.jewelicious.scope.SessionScopedBean;
...
public class ScopeController {
    ...
    public ResponseEntity<String> testRequestScope() {
        ...
        return ResponseEntity.ok()
                .body(requestScopedBean.getUserName());
    }
    ...
    public ResponseEntity<String> testSessionScope() {
        ...
        return ResponseEntity.ok()
                .body(sessionScopedBean.getUserName());
    }

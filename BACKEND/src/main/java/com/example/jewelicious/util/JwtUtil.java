package com.example.jewelicious.util;

import com.example.jewelicious.constants.ApplicationConstants;
...
public class JwtUtil {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        jwt = Jwts.builder().issuer("Jewelicious").subject("JWT Token")
